...
- `artifacts/review/evidence/M0005/review-manifest.md` records input/output provenance and SHA-256 hashes. `artifacts/review/session/M0005-render-5/page-1.png` was rendered with the documents verification workflow and visually inspected.
